...
train_data.to_csv(
    f'./data/train_text01_{PREV_TEXT_ORDER}_{CUR_PREV_ORDER}_{ADD_SCENE_TEXT}_{ADD_CHARACTER_TEXT}_{MAX_SEQ_LEN}.csv')
test_data.to_csv(
    f'./data/test_text01_{PREV_TEXT_ORDER}_{CUR_PREV_ORDER}_{ADD_SCENE_TEXT}_{ADD_CHARACTER_TEXT}_{MAX_SEQ_LEN}.csv')
